...
const Rulepage = () => {
  ...
  const ruledetail = [
        ...
        "***หากคุณโพสต์เนื้อหาที่สนับสนุนผู้ใช้อื่นในการละเมิดข้อกำหนดในการให้บริการ เนื้อหาเหล่านั้นอาจะถูกลบ บัญชีของคุณอาจถูกลงโทษ และในบางกรณีอาจถูกยุติการใช้งานได้***",
        "***ดังนั้นหากไม่อยากให้วีดีโอของคุณถูกลบ ช่องของคุณถูกแบน หรือถูกลบบัญชีถาวร ก็ให้อ่านกฎและปฏิบัติภายใต้เงื่อนไขการอยู่ร่วมกันด้วย***",
      ];

  const details = ruledetail.map((rule, index) => <li key={index}>{rule}</li>);
  ...
  return (
    <>
      ...
      <div className="mt-7 flex justify-start card w-[1000px] h-[450px] relative bg-white rounded-[20px] mx-auto text-clip overflow-y-auto">
